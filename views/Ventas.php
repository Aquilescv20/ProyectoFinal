                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <?php
                                ...
                                $result = mysqli_query($conexion, "SELECT COUNT(*) AS total FROM personal;");
...
<div class="container-fluid row" id="personal">
    ...
    <div class="col-10 p-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#agregarpersonal">
                    Agregar
                </button>
            </div>
        </div>
        <div class="container">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                    require_once("../php/db.php");
                    $result = mysqli_query($conexion, "SELECT personal.ID, personal.NOMBRE, personal.APELLIDOP, personal.APELLIDOM, personal.DNI, personal.EMAIL, personal.TELEFONO, personal.DIRECCION, cargo.PERS 
                        FROM personal INNER JOIN cargo ON personal.ID_CARGO = cargo.ID;");
                    while ($fila = mysqli_fetch_assoc($result)):
                        ?>
                        <tr>
                            <td>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                    data-target="#editarpersonal<?php echo $fila['ID']; ?>">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                                <a href="../php/eliminarper.php?id=<?php echo $fila['ID']; ?>" class="btn btn-danger"
